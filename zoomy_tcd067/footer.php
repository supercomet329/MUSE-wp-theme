...
<footer class="p-b-10">
	<div class="navbar  navbar-light bg-light shadow fixed-bottom">
		<a href="/"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/icon/home.png" alt="home" width="100" height="100"></a>
		<!-- <strong>Home</strong> -->
		...
		<a href="<?php echo esc_url( get_tcd_membership_memberpage_url( 'add_photo' ) ); ?>"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/icon/post.png" alt="post" width="100" height="100"></a>
		<!-- <strong>Post</strong> -->
