...
<div class="container pt-2">
    <form class="p-membership-form p-membership-form--registration<?php if (!empty($tcd_membership_vars['registration']['complete'])) echo ' is-complete'; ?>" action="<?php echo esc_attr(get_tcd_membership_memberpage_url('request')); ?>" enctype="multipart/form-data" method="post">
        ...
        <?php if (isset($_GET['status'])) : ?>
            <div class="p-membership-form__error">登録が完了しました。</div>
        <?php endif; ?>
        ...
        <div class="row">
            ...
            <div class="col-12 pb-3">
                <input type="text" name="title" class="form-control" placeholder="タイトルを入力" value="<?php echo esc_attr(isset($_REQUEST['title']) ? $_REQUEST['title'] : $request->title); ?>" required>
            </div>
            <div class="col-12 pb-2">
                <div class="form-group">
                    <label for="content">依頼内容　（必須）</label>
                    <textarea class="form-control" name="content" id="content" rows="6" required><?php echo esc_textarea(isset($_REQUEST['content']) ? $_REQUEST['content'] : $request->content); ?></textarea>
                </div>
            </div>
            <div class="col-12">
                <div class="form-group">
            ...
            <div class="col-12 pb-3">
                <input type="url" name="url" class="form-control" value="<?php echo esc_attr(isset($_REQUEST['url']) ? $_REQUEST['url'] : $request->url); ?>" />
            </div>
            <div class="col-12">
            ...
            <div class="col-12 pb-4">
                <input type="number" name="money" class="form-control" value="<?php echo esc_attr(isset($_REQUEST['money']) ? $_REQUEST['money'] : $request->money); ?>" placeholder="金額を入力" />
            </div>
            <div class="col-12 pb-3">
                <div class="custom-control custom-radio custom-control-inline">
