...
<div class="container pt-2">
    <form action="" method="post">
        <div class="row">
            ...
            <div class="col-12 border-bottom">
                <?php echo number_format($tcd_membership_vars['requestData']['deadline']); ?>
            </div>
            <div class="col-12 pt-2">
            ...
            <div class="col-12">
                <div class="d-flex justify-content-center pt-4 pb-2">
                    <button type="button" class="btn btn-primary text-white btn-block gradient-custom-4 font-weight-bold">投稿する
                    </button>
                </div>
            </div>
        </div>
