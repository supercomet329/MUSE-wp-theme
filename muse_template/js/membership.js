        ...
        $.ajax({
            ...
            success: function(data, textStatus, XMLHttpRequest) {
                ...
                if (data.result == 'added') {
                    ...
                    $(el).removeClass('js-toggle-follow btn py-0 rounded-pill btn-outline-primary btn-sm follow-btn follow-off');
                    ...
                    $(el).addClass('js-toggle-follow btn py-0 rounded-pill btn-outline-primary btn-sm follow-btn follow-off');
                    $(el).text('フォローする');
    ...
    var ajaxToggleKeep = function(el, post_id) {
        ...
        $.ajax({
            ...
            success: function(data, textStatus, XMLHttpRequest) {
                ...
                if (data.result == 'added') {
                    // $(el).addClass('p-icon-liked').removeClass('p-icon-like').html(data.likes_number);
                    $(el).attr('src', '/wp-content/themes/muse_template/assets/img/icon/keep_on.png');
                } else if (data.result == 'removed') {
                    // $(el).addClass('p-icon-like').removeClass('p-icon-liked').html(data.likes_number);
                    $(el).attr('src', '/wp-content/themes/muse_template/assets/img/icon/keep_off.png');
                } else if (data.message) {
                    showModalAlert(data.message);
                } else {
                    showModalAlert(TCD_MEMBERSHIP.ajax_error_message);
