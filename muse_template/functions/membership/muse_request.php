...
function tcd_membership_action_list_received()
{
    ...
    $tcd_membership_vars['list_order'] = $listReceived;
    $tcd_membership_vars['post_data']  = $postData;
    $tcd_membership_vars['array_budget']  = ARRAY_BUDGET;
}
...
function tcd_membership_action_order_search()
{
    ...
    // 依頼の一覧を取得
    $listOrder = searchOrder($sort, $search_txt, $sel_up_budget, $sel_down_budget, $sel_limit);
 ...
 * 依頼一覧の取得
 */
function searchOrder($sort, $search_txt, $sel_up_budget, $sel_down_budget, $sel_limit)
{
    global $wpdb;
