...
function get_latest_theme_version( $interval ) {
	...
	$notifier_file_url = 'http://design-plus1.com/notifier_zoomy.xml';
	$db_cache_field = 'zoomy-contempo-notifier-cache';
	$db_cache_field_last_updated = 'zoomy-contempo-notifier-last-updated';
