...
function tcd_add_quicktags() {
	$tcdQuicktagsL10n = array(
		...
		'style2a' => array(
			'display' => __( 'H2 styleA', 'tcd-w' ),
			'tag' => __( '<h2 class="style2a">Heading 2 styleA</h2>', 'tcd-w' )
		),
		'style2b' => array(
			'display' => __( 'H2 styleB', 'tcd-w' ),
			'tag' => __( '<h2 class="style2b">Heading 2 styleB</h2>', 'tcd-w' )
		),
		'style3a' => array(
