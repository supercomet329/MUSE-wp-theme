                                        ...
                                        <?php if ($type === 'like') { ?>
                                            ...
                                            ?>
                                                <li class="pt-2 icon-box">
                                                    <img src="<?php echo esc_url($profile_image); ?>" class="rounded-circle" width="50" height="50">
                                                    <div class="font-weight-bold">
                                                        <?php echo esc_attr($user->display_name); ?>さんが「いいね」しました。
                                                    </div>
                                                    <div class="screen_id">
                                                        <a href="<?php echo esc_url(get_tcd_membership_memberpage_url('post_comment')); ?>&post_id=<?php echo esc_attr($post->ID); ?>"><?php echo $post->post_title; ?></a>
                                                    </div>
                                                </li>
                                            <?php }
                                            /** endforeach */ ?>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <ul class="list-area">
                                ...
                                ?>
                                    <li class="pt-2 icon-box">
                                        <img src="<?php echo esc_url($profileImage); ?>" class="rounded-circle" width="50" height="50">
                                        <div class="font-weight-bold">
