                        ...
                        <div class="row my-2">
                            ...
                            <div class="col-4 d-block d-lg-none btn-area text-right pl-0 my-auto">
                                <?php if (is_following($one_follow->user_id)) { ?>
                                    <a href="#" id="follow_button" data-user-id="<?php echo esc_attr($one_follow->user_id); ?>" class="js-toggle-follow btn btn-primary rounded-pill btn-sm text-white btn-lg main-color follow-btn follow-on">フォロー中</a>
                                <?php } else { ?>
                                    <a href="#" id="follow_button" data-user-id="<?php echo esc_attr($one_follow->user_id); ?>" class="js-toggle-follow btn py-0 rounded-pill btn-outline-primary btn-sm follow-btn follow-off">フォローする</a>
                                <?php } ?>
                            </div>
