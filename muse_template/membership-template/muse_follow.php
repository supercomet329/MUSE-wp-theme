...
<div class="pc-center">
    ...
    <div class="container pt-2">
        ...
        <div class="text-center font-weight-bold title mt-0">
            フォロー一覧
        </div>
        <div class="row">
            <div class="col-12">
                    ...
                    ?>
                        <div class="row my-2">
                            ...
                            <?php if (is_following($one_follow->target_user_id)) { ?>
                                <a href="#" id="follow_button" data-user-id="<?php echo esc_attr($one_follow->target_user_id); ?>" class="js-toggle-follow btn btn-primary rounded-pill btn-sm text-white btn-lg main-color follow-btn follow-on">フォロー中</a>
                            <?php } else { ?>
                                <a href="#" id="follow_button" data-user-id="<?php echo esc_attr($one_follow->target_user_id); ?>" class="js-toggle-follow btn py-0 rounded-pill btn-outline-primary btn-sm follow-btn follow-off">フォローする</a>
                            <?php } ?>
                            </div>
