...
<div class="theme_option_field cf">
	...
	<p><?php _e( '"export"　"import" "reset", both membership system options are included. (Settings including membership options are reset.)', 'tcd-w' ); ?></p>
	...
	<div class="theme_option_message">
		<p><?php _e( 'By pressing the "export" button, you can download TCD theme options setting file as json file. Example of setting file name: tcd_theme_options-export-WordPress theme "ZOOMY" - ZOOMY - 20190131.json "', 'tcd-w' ); ?></p>
	...
	<div class="theme_option_message">
		...
		<p><?php _e( 'By adding a check at reset time, we add samples of main contents (articles, images, categories, menus) that make up the site. By doing this, you can replace images and insert texts while checking the actual layout.', 'tcd-w' ); ?></p>
	</div>
	...
	<ul>
		...
		<li><label style="vertical-align: baseline;"><input name="tcd-tools-reset-sample-menus" type="checkbox" value="1"><?php _e( 'Add sample menu', 'tcd-w' ); ?></label> <small class="description"><?php _e( 'Note: Sample menu will not be added if the \"Global menu\" or \"Sample menu\" already exist.', 'tcd-w' ); ?></small></li>
