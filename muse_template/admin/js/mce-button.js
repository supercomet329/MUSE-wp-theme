	...
	tinymce.PluginManager.add('tcd_mce_button', function( editor, url ) {
		editor.addButton( 'tcd_mce_button', {
			...
			menu: [
				...
				{
				// H2見出しa
					text: tcdQuicktagsL10n.style2a.display,
					onclick: function() {
						editor.insertContent(tcdQuicktagsL10n.style2a.tag);
					}
				},
				{
				// H2見出しb
					text: tcdQuicktagsL10n.style2b.display,
					onclick: function() {
						editor.insertContent(tcdQuicktagsL10n.style2b.tag);
					}
				},
				{
					// H3見出しa
