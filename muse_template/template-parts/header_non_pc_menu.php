    ...
    <body <?php body_class(); ?>>
        ...
        <header class="popular_artist">
            <nav class="navbar navbar-light bg-light">
                ...
                <a href="/"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/icon/logo.png" alt="logo" class="logo-sp"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/icon/logo.png" alt="logo" class="logo-pc"></a>
