    ...
    <main role="main" class="mb-2">
        ...
        ?>
            ...
            <div class="content-item shadow-sm d-flex align-items-center justify-content-center px-1">
                ...
                <a href="<?php echo esc_html(get_tcd_membership_memberpage_url('confirm_post')); ?>&post_id=<?php echo esc_html($one_photo->post_id); ?>"><img class="image-list" src="<?php echo esc_html($one_photo->meta_value); ?>"></a>
            </div>
                <?php }
                /** endforeach */ ?>
            </div>
