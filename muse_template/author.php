...
$listFavorite = muse_list_favorite($user->ID);
        ...
        <div class="row mt-2">
            <div class="col-12 text-right profile-btn">
                <?php if (get_current_user_id() == $user_id) { ?>
                    ...
                    <a href="<?php echo esc_url(get_tcd_membership_memberpage_url('edit_profile')); ?>"><button class="px-0 btn rounded-pill btn-outline-primary outline-btn btn-sm">　編集　</button></a>
                <?php } else { ?>
                    <!-- 自分以外が見た場合 -->
